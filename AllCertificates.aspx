...
.table-cert {
    ...
    .table-cert th a,
    .table-cert th span { display:inline; padding:0; margin:0; }

    .table-cert tr:not(:first-child) { border-bottom:1px solid rgba(15,32,68,.05); }
    .table-cert tr:last-child { border-bottom:none; }
    .table-cert tr:hover td { background:#faf8f4; }
    ...
    .table-cert th:last-child { min-width: 180px; white-space: nowrap;
}
