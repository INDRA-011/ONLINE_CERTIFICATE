...
/* ✅ FIX: Force consistent page size */
@page {
...
@media print {
    ...
    /* ✅ FIX: remove container restrictions */
...
/* KEEP flex for screen, only changed in print */
.signature-section {
    display: flex;
